 ...
 */
class godicheabox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "godichea@godichea";
    public $boxlabel;
    public $depends = array("godichea");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/godichea/class/godichea.class.php";
