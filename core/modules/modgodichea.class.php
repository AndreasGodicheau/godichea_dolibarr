...
/**
 * 	\defgroup   godichea     Module godichea
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/godichea/core/modules directory.
 *  \file       htdocs/godichea/core/modules/modgodichea.class.php
 *  \ingroup    godichea
...
class modgodichea extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		// for specific path of parts (eg: /godichea/core/modules/barcode)
		// for specific css file (eg: /godichea/css/godichea.css.php)
        ...
        */
		...
		//							'titre'=>'godichea top menu',
		//							'mainmenu'=>'godichea',
		//							'leftmenu'=>'godichea',
		//							'url'=>'/godichea/pagetop.php',
		//							'langs'=>'mylangfile@godichea',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->godichea->enabled',	// Define condition to show or hide menu entry. Use '$conf->godichea->enabled' if entry must be visible if module is enabled.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->godichea->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		...
		//							'titre'=>'godichea left menu',
		//							'mainmenu'=>'xxx',
		//							'leftmenu'=>'godichea',
		//							'url'=>'/godichea/pagelevel2.php',
		//							'langs'=>'mylangfile@godichea',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->godichea->enabled',  // Define condition to show or hide menu entry. Use '$conf->godichea->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->godichea->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		//							'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		// $r++;
